        ...
        <table class="demandes-table">
          ...
          <tbody>
            <tr v-for="user in sortedUsers" :key="user.id_user">
              ...
              <td><button class="btn btn-outline btn-sm" @click="openEditUserModal(user)">Éditer</button></td>
            </tr>
          </tbody>
        </table>
    ...
    <div class="modal-overlay" :class="{ active: isEditModalOpen }" @click.self="closeEditModal">
      <div class="modal-content" style="max-width: 800px; max-height: 90vh; overflow-y: auto;">
          ...
          <div class="form-group" v-if="editingSae.vignette_path">
              ...
              <img :src="'http://localhost:3000' + editingSae.vignette_path" style="max-width:150px; border-radius:4px; border:1px solid #ccc; margin-bottom: 8px;">
          </div>
              ...
              <div>
                  ...
                  <div v-if="editingSae.existingConsignes && editingSae.existingConsignes.length > 0" style="margin-bottom:12px;">
                      ...
                      <div v-for="(f, i) in editingSae.existingConsignes" :key="'ex-'+i" style="display: flex; justify-content: space-between; align-items:center; font-size: 13px; padding: 6px 10px; background: #f1f5f9; margin-bottom: 4px; border-radius: 4px;">
                          <a :href="'http://localhost:3000' + f" target="_blank" style="text-decoration:none; color:#3b82f6; display:flex; align-items:center; gap:8px;">
