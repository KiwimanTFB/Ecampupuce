<template>
  <aside>
      ...
      <div class="nav-group">
          <div class="nav-label">Gestion Pédagogique</div>
          <nav>
              ...
              <router-link to="/teacher/create-sae" active-class="active">
      ...
      <div class="nav-group">
          ...
          <nav>
              <router-link to="/teacher/announcements" active-class="active">
